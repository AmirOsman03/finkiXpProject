            ...
            <div className="flex items-center gap-4">
                ...
                {isLoggedIn ? (
                    <button
                        ...
                        className="bg-red-500 hover:bg-red-600 text-white font-medium px-6 py-2 rounded-full transition-all duration-200 hover:scale-105 shadow-lg cursor-pointer"
                    >
                        Logout
                    </button>
                ) : (
