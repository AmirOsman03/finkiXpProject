...
const CompletedPage = () => {
    ...
    return (
        <div
            ...
            {/* Main card container */}
            <div
                className="max-w-md w-full bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/30 relative z-10 transform transition-all duration-300 hover:shadow-3xl">
                {/* Decorative gradient elements */}
                <div
                    className="absolute -top-32 -right-32 w-80 h-80 bg-blue-200 rounded-full opacity-10 blur-3xl -z-10"></div>
                <div
                    className="absolute -bottom-32 -left-32 w-80 h-80 bg-purple-200 rounded-full opacity-10 blur-3xl -z-10"></div>

                <div className="p-8 text-center">
                    {/* Success icon with pulse animation */}
                    <div className="mb-8 animate-bounce-in">
                        <div
                            className="inline-flex items-center justify-center w-28 h-28 bg-gradient-to-br from-green-100 to-green-200 rounded-full shadow-inner relative">
                            <FaCheckCircle className="text-green-500 text-7xl drop-shadow-md"/>
                            <div
                                className="absolute inset-0 rounded-full border-4 border-green-300 opacity-0 animate-ping-slow"/>
                        </div>
                    </div>
